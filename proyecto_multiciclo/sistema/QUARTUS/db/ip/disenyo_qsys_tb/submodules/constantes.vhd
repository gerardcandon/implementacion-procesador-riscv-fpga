...
constant tam_mem_direcc: natural := 28;
constant num_direcciones: natural := 64;
subtype mem_direcc is std_logic_vector(tam_mem_direcc-1 downto 0);
constant csr_addr_begin: mem_direcc := x"9000000";
constant csr_addr_end: mem_direcc := x"900000c";
...
constant mRLDM_SDRAM: st_mx2_sel := '0';
constant mRLDM_CSR: st_mx2_sel := '1';
...
constant DIR_mtimel:    mem_direcc := x"9000000";
constant DIR_mtimeh:	mem_direcc := x"9000004";
constant DIR_mtimecmpl: mem_direcc := x"9000008";
constant DIR_mtimecmph: mem_direcc := x"900000c";

--mstatus
constant UIE:  natural := 0;	
constant MIE:  natural := 3;
constant UPIE: natural := 4;
constant MPIE: natural := 7;
constant MPP0: natural := 11;
constant MPP1: natural := 12;
...
constant causa_loadNoAlineado    : dato_camino := x"00000004";
constant causa_loadFueraDeRango  : dato_camino := x"00000005";
constant causa_storeNoAlineado   : dato_camino := x"00000006";
constant causa_storeFueraDeRango : dato_camino := x"00000007";

--controlador_interrupciones
constant tam_irq: natural := 1;
