// disenyo_qsys_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module disenyo_qsys_mm_interconnect_1 (
	...
	wire  [101:0] rsp_mux_src_data;                                                                                    // rsp_mux:src_data -> video_pixel_buffer_dma_0_avalon_pixel_dma_master_agent:rp_data
	...
	wire   [84:0] sram_0_avalon_sram_slave_agent_rf_source_data;                                                       // sram_0_avalon_sram_slave_agent:rf_source_data -> sram_0_avalon_sram_slave_agent_rsp_fifo:in_data
	...
	wire   [84:0] sram_0_avalon_sram_slave_agent_rsp_fifo_out_data;                                                    // sram_0_avalon_sram_slave_agent_rsp_fifo:out_data -> sram_0_avalon_sram_slave_agent:rf_sink_data
	...
	wire  [101:0] video_pixel_buffer_dma_0_avalon_pixel_dma_master_agent_cp_data;                                      // video_pixel_buffer_dma_0_avalon_pixel_dma_master_agent:cp_data -> router:sink_data
	...
	wire          sram_0_avalon_sram_slave_agent_rp_valid;                                                             // sram_0_avalon_sram_slave_agent:rp_valid -> router_001:sink_valid
	wire   [83:0] sram_0_avalon_sram_slave_agent_rp_data;                                                              // sram_0_avalon_sram_slave_agent:rp_data -> router_001:sink_data
	wire          sram_0_avalon_sram_slave_agent_rp_ready;                                                             // router_001:sink_ready -> sram_0_avalon_sram_slave_agent:rp_ready
	wire          sram_0_avalon_sram_slave_agent_rp_startofpacket;                                                     // sram_0_avalon_sram_slave_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          sram_0_avalon_sram_slave_agent_rp_endofpacket;                                                       // sram_0_avalon_sram_slave_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire   [83:0] sram_0_avalon_sram_slave_burst_adapter_source0_data;                                                 // sram_0_avalon_sram_slave_burst_adapter:source0_data -> sram_0_avalon_sram_slave_agent:cp_data
	...
	wire    [0:0] sram_0_avalon_sram_slave_burst_adapter_source0_channel;                                              // sram_0_avalon_sram_slave_burst_adapter:source0_channel -> sram_0_avalon_sram_slave_agent:cp_channel
	...
	wire          router_001_src_valid;                                                                                // router_001:src_valid -> sram_0_avalon_sram_slave_rsp_width_adapter:in_valid
	wire   [83:0] router_001_src_data;                                                                                 // router_001:src_data -> sram_0_avalon_sram_slave_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                                                                // sram_0_avalon_sram_slave_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [0:0] router_001_src_channel;                                                                              // router_001:src_channel -> sram_0_avalon_sram_slave_rsp_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                                                        // router_001:src_startofpacket -> sram_0_avalon_sram_slave_rsp_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                                                          // router_001:src_endofpacket -> sram_0_avalon_sram_slave_rsp_width_adapter:in_endofpacket
	...
	wire  [101:0] sram_0_avalon_sram_slave_rsp_width_adapter_src_data;                                                 // sram_0_avalon_sram_slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [0:0] sram_0_avalon_sram_slave_rsp_width_adapter_src_channel;                                              // sram_0_avalon_sram_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [101:0] cmd_mux_src_data;                                                                                    // cmd_mux:src_data -> sram_0_avalon_sram_slave_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                                   // sram_0_avalon_sram_slave_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [0:0] cmd_mux_src_channel;                                                                                 // cmd_mux:src_channel -> sram_0_avalon_sram_slave_cmd_width_adapter:in_channel
	...
	wire   [83:0] sram_0_avalon_sram_slave_cmd_width_adapter_src_data;                                                 // sram_0_avalon_sram_slave_cmd_width_adapter:out_data -> sram_0_avalon_sram_slave_burst_adapter:sink0_data
	...
	wire    [0:0] sram_0_avalon_sram_slave_cmd_width_adapter_src_channel;                                              // sram_0_avalon_sram_slave_cmd_width_adapter:out_channel -> sram_0_avalon_sram_slave_burst_adapter:sink0_channel
	...
	disenyo_qsys_mm_interconnect_1_router router (
	...
	disenyo_qsys_mm_interconnect_1_router_001 router_001 (
	...
	disenyo_qsys_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (video_pixel_buffer_dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	disenyo_qsys_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                              //       clk.clk
		.reset               (video_pixel_buffer_dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	disenyo_qsys_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (video_pixel_buffer_dma_0_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	disenyo_qsys_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                              //       clk.clk
		.reset               (video_pixel_buffer_dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	disenyo_qsys_mm_interconnect_1_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
