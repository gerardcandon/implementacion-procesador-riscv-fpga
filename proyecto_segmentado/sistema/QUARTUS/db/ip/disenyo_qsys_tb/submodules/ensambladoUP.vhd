...
mRLDM: mux2_32 port map (d0 => readdata, d1 => readdata_csr, SEL => mRLDM_sel, s => mRLDM_RLDM);

RLDM: reg32 port map (reloj => reloj, Pcero => Pcero, e => mRLDM_RLDM, s => RLDM_FMTL);
