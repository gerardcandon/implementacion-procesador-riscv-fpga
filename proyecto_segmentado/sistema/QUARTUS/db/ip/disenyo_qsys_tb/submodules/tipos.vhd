...
--UNIDAD DE CONTROL
--BR_CSR
subtype st_csr is std_logic_vector(tam_csr-1 downto 0);
subtype st_csr_64 is std_logic_vector(tam_csr_64-1 downto 0);
subtype st_irq is std_logic_vector(tam_irq-1 downto 0);
subtype csr_direcc is std_logic_vector(tam_csr_direcc-1 downto 0);
